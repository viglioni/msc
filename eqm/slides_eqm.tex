...
\end{block}
\end{frame}
\begin{frame}[label={sec:org81e23de}]{The \emph{H} space}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orgd8b5144}]{The \emph{H} space}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orgb658876}]{Number Fields}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org2612ebd}]{Twisted embeddings}
\begin{text}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgc0101b8}]{Twisted embeddings and number fields}
\begin{text}
...
\end{frame}
\section{Objectives}
\label{sec:org1f0c4f3}
\begin{frame}[label={sec:org8d49e4a}]{Main goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org96ebd6b}]{Practical aspects}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga8b4e59}]{Theoretical aspects}
\begin{itemize}
...
\label{sec:org40b526b}
\begin{frame}[label={sec:org2e451b1}]{Methodology}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org646bfe7}]{Timeline}
\begin{itemize}
