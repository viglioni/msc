...
\label{sec:org5c24cb5}
\subsubsection*{Motivation}
\label{sec:org3b595ef}
...
\label{sec:org204178b}
\subsubsection*{Organization of this document}
\label{sec:orgb986113}
\section{Mathematical background}
\label{sec:org8f6df47}
\subsection{Preliminaries}
\label{sec:orgd7b61d7}
...
\subsection{Lattices}
\label{sec:org5ff762c}
\subsubsection{Basic definitions}
\label{sec:org2321370}
...
\label{sec:orgeb8c95f}
\subsubsection{Embeddings}
\label{sec:orga17c0e1}
...
\label{sec:orgdbd0c4b}

\subsection{Twisted Ring-LWE}
\label{sec:orgca93e90}
...
\section{Methodology}
\label{sec:org3c53f7a}
\subsection{Literature review}
\label{sec:org7c63340}
...
\section{Cronograma}
\label{sec:org22b5fcd}
\subsection{Activities}
\label{sec:org44949cf}
\begin{itemize}
