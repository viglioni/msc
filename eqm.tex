...
\label{sec:org44b8461}
\subsubsection*{Summary of objectives}
\label{sec:org7cd88af}
\subsubsection*{Organization of this document}
\label{sec:org0edff0c}
\section{Mathematical background}
\label{sec:org0dc7bf3}
\subsection{Preliminaries}
\label{sec:org353e16e}
...
\subsection{Lattices}
\label{sec:orgd644982}
\subsubsection{Basic definitions}
\label{sec:org4aa3eff}
...
\label{sec:org21a739f}
\subsubsection{Embeddings}
\label{sec:org709839a}
...
\label{sec:org98307f2}
\subsection{Twisted Ring-LWE}
\label{sec:org728a6ad}
...
\label{sec:orgf91d663}
\subsubsection{generaliza o mergulho can construir mais reticulados}
\label{sec:org014b7ca}
...
\begin{itemize}
\item amostragem de erros -> segurança (reticulado), implementaçao rapida polinomial
\begin{itemize}
\item zn rotacionado amostragem de erros nao precisa converter pra pol
\end{itemize}
\end{itemize}


\section{Objectives}
\label{sec:orgab51583}
...
\section{Methodology}
\label{sec:org0ced550}
\subsection{Literature review}
\label{sec:orgf86856b}
\subsection{Activities}
\label{sec:org117c42f}
\begin{itemize}
\item Second semester of 2021
\item \ldots{}
\end{itemize}
\section{Conclusion}
\label{sec:orgd7b7d19}
