...
\label{sec:orgc3fc00f}
\begin{frame}[label={sec:orgb7fe876}]{Lattices}
A \textbf{lattice} \(\Lambda \subset \R^n\) is a subgroup of the additive group \(\R^n\).
\end{frame}
\begin{frame}[label={sec:org5123d09}]{Lattices}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org025fab6}]{Lattices and cryptography}
...
\end{frame}
\begin{frame}[label={sec:orge9a22ea}]{Lattices problems}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgea025e7}]{The \emph{H} space}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org1d00599}]{The \emph{H} space}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orgd8377ab}]{Number Fields}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orge7d0894}]{Twisted embeddings}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org25e79a0}]{Twisted embeddings}
\begin{theorem}
...
\begin{frame}[label={sec:org9848aa0}]{Twisted embeddings}
\begin{text}
...
\label{sec:org7eca8df}
\begin{frame}[label={sec:orgccb37b2}]{Learning from Parity}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org02cee52}]{Learning with Errors}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orgecefd7b}]{Ring-LWE search}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orge954880}]{Twisted Ring-LWE}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org12075bd}]{Twisted Ring-LWE hardness}
...
\label{sec:orga7054d7}
\begin{frame}[label={sec:org327ca70}]{Cryptosystem presented by Ortiz et al.}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org35f6810}]{Cryptosystem presented by Ortiz et al.}
 \begin{itemize}
...
\end{frame}
\section{Objectives}
\label{sec:orgb4ca07c}
\begin{frame}[label={sec:org6b88cf9}]{Main goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd19a2ad}]{Practical aspects}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd6c6e43}]{Theoretical aspects}
\begin{itemize}
...
\label{sec:org9f415ac}
\begin{frame}[label={sec:org2083a93}]{Methodology}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf69f063}]{Timeline}
\begin{itemize}
