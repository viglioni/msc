...
\label{sec:org2867547}
\begin{frame}[label={sec:org726d533}]{Lattices}
A \textbf{lattice} \(\Lambda \subset \R^n\) is a subgroup of the additive group \(\R^n\).
\end{frame}
\begin{frame}[label={sec:org110c784}]{Lattices}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org7e3f525}]{Lattices and cryptography}
...
\end{frame}
\begin{frame}[label={sec:org449a96d}]{Lattices problems}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5f26154}]{The \emph{H} space}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orgc11f8b4}]{The \emph{H} space}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org666f114}]{Number Fields}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org6fdd867}]{Twisted embeddings}
\begin{text}
...
\label{sec:org3c1e561}
\begin{frame}[label={sec:orgd6d391b}]{Learning from Parity}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org45ff86c}]{Learning with Errors}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:orgd85e044}]{Ring-LWE search}
\begin{text}
...
\end{text}
\end{frame}
\begin{frame}[label={sec:org38aa393}]{Twisted Ring-LWE}
\begin{text}
...
\end{frame}
\section{Objectives}
\label{sec:orgc49f043}
\begin{frame}[label={sec:org053c7ee}]{Main goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4bd7402}]{Practical aspects}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1852e06}]{Theoretical aspects}
\begin{itemize}
...
\label{sec:orgd73127e}
\begin{frame}[label={sec:orgdb1fbe6}]{Methodology}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2e39b9c}]{Timeline}
\begin{itemize}
